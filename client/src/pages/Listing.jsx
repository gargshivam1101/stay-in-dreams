        ...
        <div>
          <Swiper navigation>
            {listing.imageUrls.map((url) => (
              ...
              <SwiperSlide key={url}>
                <div
                  className="h-96 flex max-w-5xl mx-auto"
                  style={{
          ...
          <div className="flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4">
            <p className="text-2xl font-semibold text-gray-600">
              {listing.name} - ${/* show discount price if we have offer */}
              {listing.offer
                ? listing.discountPrice.toLocaleString("en-US")
                : listing.regularPrice.toLocaleString("en-US")}
              {listing.type === "rent" && " / month"}
            </p>
            <p className="flex items-center mt-6 gap-2 text-gray-600 text-md">
            ...
            <ul className="text-green-800 font-semibold text-sm flex flex-wrap items-center gap-4 sm:gap-6">
              ...
              <li
                className={`flex items-center gap-1 whitespace-nowrap ${
                  !listing.furnished ? "text-red-800" : ""
                } `}
              >
            ...
            {/* only show if user is logged in, and is not the landlord himself */}
...
{
  /* http://localhost:5173/listing/66e85b750e5f8da527bd43ca */
}
